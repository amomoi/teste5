...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradors_url, params: { administrador: { cpf: @administrador.cpf, email: @administrador.email, nome: @administrador.nome, senha: @administrador.senha } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { cpf: @administrador.cpf, email: @administrador.email, nome: @administrador.nome, senha: @administrador.senha } }
