...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { cliente_id: @sensor.cliente_id, nome_sensor: @sensor.nome_sensor, tipo_sensor_id: @sensor.tipo_sensor_id } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { cliente_id: @sensor.cliente_id, nome_sensor: @sensor.nome_sensor, tipo_sensor_id: @sensor.tipo_sensor_id } }
