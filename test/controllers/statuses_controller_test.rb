...
class StatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference('Status.count') do
      post statuses_url, params: { status: { flag: @status.flag, sensor_id: @status.sensor_id } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { flag: @status.flag, sensor_id: @status.sensor_id } }
